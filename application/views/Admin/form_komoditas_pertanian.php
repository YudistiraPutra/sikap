                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <?php echo form_open('Admin/tambah_komoditas_pertanian'); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                             ...
                                             <?php echo form_error('det_kmd_id'); ?>
                                        </div>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                             ...
                                             <?php echo form_error('kec_id'); ?>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 form-control-label text-xs-right"> Jumlah Tanam (Ha): </label>
                                            <div class="col-sm-10">
                                            <input type="number" class="form-control boxed" name="tanam" placeholder=""> </div>
                                            <?php echo form_error('tanam'); ?>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 form-control-label text-xs-right"> Jumlah Panen (Ha): </label>
                                            <div class="col-sm-10">
                                            <input type="number" class="form-control boxed" name="panen" placeholder=""> </div>
                                            <?php echo form_error('panen'); ?>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 form-control-label text-xs-right"> Jumlah Provitas (Kw/Ha): </label>
                                            <div class="col-sm-10">
                                            <input type="number" class="form-control boxed" name="provitas" placeholder=""> </div>
                                            <?php echo form_error('provitas'); ?>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 form-control-label text-xs-right"> Jumlah Produksi (Ton): </label>
                                            <div class="col-sm-10">
                                            <input type="number" class="form-control boxed" name="produksi" placeholder="" id="produksi" onchange="fungsihitung()"> </div>
