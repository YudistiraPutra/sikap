                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <?php echo form_open('Diskehan/tambahpenduduk'); ?>
                                        <div class="card-title-block">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <br><?php echo form_error('pend_kec_id'); ?></div> 
                                         </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <br><?php echo form_error('pend_thn'); ?></div>
                                     </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 form-control-label text-xs-right"> Jumlah Penduduk: </label>
                                            <div class="col-sm-10">
                                            <input type="number" class="form-control boxed" name="pend_jml" placeholder=""> 
                                            <br><?php echo form_error('pend_jml'); ?></div>
                                        </div>
