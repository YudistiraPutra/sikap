                                                    ...
                                                    <tbody>
                                                       <?php foreach ($kecamatan as $key) { 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url()?>Diskehan/hapuskecamatan/<?php echo $key->kec_id ?>" class="btn btn-danger tombol-hapus" role="button">Hapus</a></td>
                                                            </tr>
                                                            <?php  $i=$i+1; } ?>
                                                    </tbody>
                                                </table>
...
<script>
  $(document).ready( function () {
    $('#table_id').DataTable();
        ...
        <script src=<?= base_url()?>/assets/js/scriptjs/kecamatan.js></script>
