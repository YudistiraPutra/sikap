                ...
                <article class="content charts-flot-page">
                    <div class="title-block">
                        <h3 class="title"> Konsumsi Peternakan </h3>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <?php echo form_open('Diskehan/tambah_konsumsi_peternakan'); ?>
                                        <div class="card-title-block">
                                            <h3 class="title"> Form Tambah Konsumsi Peternakan </h3>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p>Silahkan gunakan titik (.) untuk bilangan desimal</p><br><?php echo form_error('kons_jml'); ?></div>
                                        </div>
	...
	$(document).ready(function(){
        const pbaru = document.getElementById('testes');
