                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title"> Tabel Data Komoditas Perikanan </h3>
                                        </div>
                                        <div class="col-12">
                                            <a href="<?php base_url()?>tambah_komoditas_perikanan"><button type="button" class="btn btn-primary">Tambah Data</button></a>
